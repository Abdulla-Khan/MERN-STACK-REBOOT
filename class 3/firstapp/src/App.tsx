...
function App() {
  ...
  let imgPath =
    "https://images.pexels.com/photos/22880134/pexels-photo-22880134/free-photo-of-a-woman-in-a-hijab-standing-in-a-field.jpeg?auto=compress&cs=tinysrgb&w=800&lazy=load";
  tasks.sort();
  return (
    <div className="App">
      <header className="   -header">
          ...
          {a.map((value, index) => {
            return (
              <tr>
                ...
                <td>
                  LatLng({value.address.geo.lat}, {value.address.geo.lng})
                </td>
                <td>
                  {" "}
                  <a
        ...
        <h1>Task 2. Conditional Rendering</h1>
            ...
            return (
              <tbody>
                <tr>
                  ...
                  <td
                    style={
                      value.completed ? { color: "green" } : { color: "red" }
                    }
                  >
        ...
        <h1>Task 3. Add Local Images</h1>
        <img src={img} alt="black n white" />
        <h1>Task 4. Add Remote Images</h1>
        <img
          src={imgPath}
          style={{
            width: "56%",
